...
const handleReturn = async (bookingId,action) => {
  try {
    ...
    if (serverRespose.data.message == "sucess") {
      ...
      toast.success('Vehicle Accepted')
      props.getBookingList(userId)
  ...
  return (
    <div className="overflow-x-auto">
      <table className="min-w-full divide-y-2 divide-gray-200 text-sm bg-white rounded-2xl border-2">
        ...
        <tbody className="divide-y divide-gray-200">
            {props.bookings.map((data,index)=>{
                return(
                    ...
                    <td className={`whitespace-nowrap px-4 py-2 flex justify-end text-gray-700 text-center `}>
                    ...
                    <button onClick={()=>{
                      navigate("/user/bookingDetails/"+data._id)
                    }}
